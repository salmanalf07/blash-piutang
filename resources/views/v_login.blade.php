            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <hR style="height:0.1px;border:none;color:#333;background-color:#333;" "></hR>
                  ...
                  <div class="col-12">
                    <button class="btn btn-primary w-100 background-color:#682a7a !important" type="submit">Login</button>
                  </div>
                  <div class="col-12">
