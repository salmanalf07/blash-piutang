...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <form action="/import_reminderKrs3" id="form-import" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                    ...
                    <div class=" mb-3" style="width: fit-content;">
                        <a class="btn btn-primary" href="download_reminderKrs3">Download Template
                            Excel</a>
                    </div>
                    <div class="mb-3" style="width: fit-content;">
                        <form action="/reminderKrs3_clear" id="form-clear" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="modal fade" id="basicModal" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="/BlashreminderKrs3" id="form-add" method="post" enctype="multipart/form-data">
                                                    @csrf
